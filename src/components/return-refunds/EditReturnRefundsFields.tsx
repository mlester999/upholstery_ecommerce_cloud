...
import SkeletonEditReturnRefundFields from "./SkeletonEditReturnRefundsFields";

const EditReturnRefundFields = (props) => {
  const { product } = props;
  ...
  if (categoriesLoading || shopsLoading || true) {
    return <SkeletonEditReturnRefundFields />;
  }
...
export default EditReturnRefundFields;
